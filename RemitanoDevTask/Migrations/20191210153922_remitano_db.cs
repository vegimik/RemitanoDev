...
namespace RemitanoDevTask.Migrations
{
    public partial class remitano_db : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserRegisteredId = table.Column<string>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersRegistered", x => x.UserRegisteredId);
                });
